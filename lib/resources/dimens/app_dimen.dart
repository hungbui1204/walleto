...
class AppDimen {
  ...
  static AppDimen of(BuildContext context) {
    final screenWidth = context.sizeOf.width;
    final screenHeight = context.sizeOf.height;
    final devicePixelRatio = context.devicePixelRatioOf;
    ...
    switch (screenType) {
      ...
      case ScreenType.ultraTablet:
        return ultraTablet?.w ??
            ((mobile * DeviceConstants.maxMobileWidth) / DeviceConstants.designDeviceHeight);
    }
  }
