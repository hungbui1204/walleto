...
//       getIt
//           .get<AppBloc>()
//           .add(NotificationTapped(notificationSourceId: message.data['notificationSourceId']));
//       getIt.get<AppNavigator>().navigateToBottomTab(BottomTab.home.index);
//       getIt.get<AppNavigator>().push(
//             AppRouteInfo.noticeDetails(
//               notificationSourceId: message.data['notificationSourceId'],
//               selectedType: message.data['selectedType'],
//             ),
//           );
//     }
//   }
