...
BEGIN
  ...
  RETURN QUERY SELECT 
    tx_record.id, tx_record.created_at, tx_record.user_id, tx_record.wallet_id,
    tx_record.amount, tx_record.category_id, tx_record.note, tx_record.type,
    tx_record.currency_code, tx_record.updated_at;
END;
